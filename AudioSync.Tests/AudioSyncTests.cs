...
namespace AudioSync.Tests
{
	...
	{
		[TestCase("https://soundcloud.com/oneokrock/start-again",
		...
		[TestCase("https://youtu.be/EjlMPu5sEgw",
				  "https://soundcloud.com/soubread/getcha-calliope-suiseicover",
				  TestName = "YouTube -> Soundcloud (GETCHA!! cover)")]
		// WHY IS EVERYTHING ON SOUNDCLOUD
		[TestCase("https://youtu.be/P4-Khg04K78",
				  "https://www.youtube.com/watch?v=P4-Khg04K78",
