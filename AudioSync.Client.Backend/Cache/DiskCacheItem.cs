...
namespace AudioSync.Client.Backend.Cache
{
	public class DiskCacheItem : ICacheItem
	{
		...
		public override bool Equals(object? obj)
			=> obj is ICacheItem cacheItem && cacheItem.SongName == SongName && cacheItem.ArtistName == ArtistName &&
			   cacheItem.CachePrefix == CachePrefix && cacheItem.FileExtension == FileExtension;

		protected bool Equals(DiskCacheItem other) => File.Equals(other.File) && CachePrefix == other.CachePrefix &&
													  ObjectCreationDateTime.Equals(other.ObjectCreationDateTime);
